...
eval "`parse_argument_and_set_variable tengine_config_doc_base config_file virtual_server_name version tengine_config_git_doc_base tengine_reload dynamic_refresh_post_data dynamic_refresh_url refresh_method env git_url git_host func`"
